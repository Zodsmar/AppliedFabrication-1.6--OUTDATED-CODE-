...
public class FabTabCraftingManager {

	/** The static instance of this class */
	private static final FabTabCraftingManager instance = new FabTabCraftingManager();
	...
	/**
	         ...
	         */
	public static final FabTabCraftingManager getInstance()
	{
	         return instance;
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	private FabTabCraftingManager()
	{
	         recipes = new ArrayList();
	        
	                //Your recipes go here

	                Collections.sort(this.recipes, new FabRecipeSorter(this));
	}
